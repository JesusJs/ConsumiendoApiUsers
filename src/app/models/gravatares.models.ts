// To parse this data:
//
//   import { Convert, Gravatares } from "./file";
//
//   const gravatares = Convert.toGravatares(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface Gravatares {
  info:    Info;
  results: Result[];
}
...
export class Convert {
  public static toGravatares(json: string): Gravatares {
      return cast(JSON.parse(json), r("Gravatares"));
  }

  public static gravataresToJson(value: Gravatares): string {
      return JSON.stringify(uncast(value, r("Gravatares")), null, 2);
  }
}
